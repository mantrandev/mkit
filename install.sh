...
say ""
say "In Claude Code, install the plugin as well. It switches the gate on:"
say "  /plugin marketplace add mantrandev/mkit"
say "  /plugin install mkit@mkit"
say ""
say "Without the plugin the agent can still change files without asking you anything."
say ""
